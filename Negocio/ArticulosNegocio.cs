...
namespace Negocio
{
    public class ArticulosNegocio
    {
        public List<Articulos> listar()
        {
            ...
            try
            {
                datos.consulta("select A.Id, A.Codigo, A.Nombre, A.Descripcion, M.Descripcion Marca, C.Descripcion Categoria, A.IdMarca, A.IdCategoria, A.ImagenUrl, Precio from ARTICULOS A, CATEGORIAS C, MARCAS M where A.IdMarca = M.Id and A.IdCategoria = C.Id");
        ...
        public List<Articulos> filtrar(string campo, string criterio, string filtroAvanzado)
        {
            ...
            try
            {
                string consulta = ("select A.Id, A.Codigo, A.Nombre, A.Descripcion, M.Descripcion Marca, C.Descripcion Categoria, A.IdMarca, A.IdCategoria, A.ImagenUrl, Precio from ARTICULOS A, CATEGORIAS C, MARCAS M where A.IdMarca = M.Id and A.IdCategoria = C.Id and ");
                ...
                else if (campo == "Codigo")
                {
                    ...
                    {
                        case "Empieza con":
                            consulta += "Codigo like '" + filtroAvanzado + "%' ";
                            break;
                        case "Termina con":
                            consulta += "Codigo like '%" + filtroAvanzado + "' ";
                            break;
